    ...
    def _get_best_neighbors(self, current_result, original_result):
        ...
        for i in range(len(neighbors_list)):
            ...
            if not len(neighbor_results):
                ...
                # print("current result score: ", current_result.score)
                score_diff = neighbor_scores - current_result.score
                # print("difference calculation: ", score_diff)
        ...
        # print("total score list: ", score_list)
        # if it does not get better, then probability of choosing it should -> 0
        prob_list = normalize(score_list)
        # print("normalized prob list: ", prob_list)
